document.addEventListener('DOMContentLoaded', () => {
  ...
  function draw(){
    ...
    if(nb && !S.animated && S.showSel){ placeSelection(nb.x, nb.y, nb.w, nb.h); } else { clearSelection(); }
  }
  ...
  function selectTile(t){ S.showSel=false;
  ...
  CANVAS.addEventListener('mousedown', (e)=>{
    ...
    if(hit){ pushHistory(); S.active.line=hit.line; S.active.word=hit.word; S.showSel=true; syncInspector(); placeSelection(hit.x,hit.y,hit.w,hit.h); }
  });
  ...
  // Resolution
  bind('resMode','change', ()=>{ S.showSel=false;
  ...
  (function init(){
    ...
    try{
      ...
      syncInspector(); S.showSel=false; clearSelection(); stopAnim();
